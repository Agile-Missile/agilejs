...
type IsCamelCase<Type> =
  Type extends Uncapitalize<Type & string> ? true : false;
 ...
 *
 * @template Type The string literal type to convert.
 */
export type CamelCase<Type> =
  IsStringLiteral<Type> extends true
